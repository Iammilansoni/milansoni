...
export const PROJECTS: Project[] = [
  {
    ...
    metrics: [
      ...
      { value: "pgvector", label: "No Managed Vector DB" },
    ],
...
export const STATS = [
  ...
  { value: "242", label: "CI-Gated Tests" },
