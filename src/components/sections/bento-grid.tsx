...
const PROOF_POINTS = [
  {
    ...
    detail:
      "Built MiningNiti — AI document intelligence with 5 specialised agents, hybrid retrieval scored by a CI-gated eval, and per-clause compliance auditing, on $0/month infrastructure.",
    links: [
