...
export const Route = createFileRoute("/work/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Explore enterprise-grade AI platforms: MiningNiti (SIH 2023 Winner, 5 AI agents, CI-gated retrieval), NLPForge (two-stage retrieval pipeline, 8 LLM providers), and SmartLearnX (AI-powered LMS, 91.4% dropout prediction accuracy) built by Milan Soni." },
      { property: "og:title", content: "AI & Full Stack Projects | Milan Soni" },
      { property: "og:description", content: "Explore enterprise-grade AI platforms: MiningNiti (SIH 2023 Winner, 5 AI agents, CI-gated retrieval), NLPForge (two-stage retrieval pipeline, 8 LLM providers), and SmartLearnX (AI-powered LMS, 91.4% dropout prediction accuracy) built by Milan Soni." },
