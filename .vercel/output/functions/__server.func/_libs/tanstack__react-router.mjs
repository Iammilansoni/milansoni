import { r as reactExports, j as jsxRuntimeExports, R as ReactExports } from "./react.mjs";
...
function ClientOnly({ children, fallback = null }) {
  return useHydrated() ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReactExports.Fragment, { children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ReactExports.Fragment, { children: fallback });
}
...
var Route = class extends BaseRoute {
  ...
  */
  constructor(options) {
    ...
    this.Link = ReactExports.forwardRef((props, ref) => {
