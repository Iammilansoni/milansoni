...
import { b as Route, R as Reveal } from "./router-DBSTBaOm.mjs";
import "../_libs/seroval.mjs";
import { r as LoaderCircle, o as ArrowLeft } from "../_libs/lucide-react.mjs";
...
function BlogPost() {
  ...
  reactExports.useEffect(() => {
    fetch(`/research/${slug}.md`).then((res) => {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-aurora-1" }) });
  }
  if (error || !content) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl", children: "Article not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/research", className: "mt-6 text-aurora-1 hover:underline", children: "← Back to research" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "relative min-h-screen pb-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aurora-bg opacity-20" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-3xl px-6 pt-32", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/research", className: "inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-4 w-4" }),
        " Back to Research"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 prose prose-invert prose-lg prose-headings:font-display prose-headings:font-normal prose-a:text-aurora-1 hover:prose-a:text-aurora-2 prose-pre:border prose-pre:border-hairline prose-pre:bg-secondary/50 max-w-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { remarkPlugins: [remarkGfm], rehypePlugins: [rehypeHighlight], children: content }) }) })
    ] })
  ] });
}
export {
